...
private suspend fun connectionStatus(name: String, result: Result<Unit>): String = result.fold(
	...
	Row(
		...
		BasicTextField(
			...
			modifier = Modifier
				...
				.border(if (focused) 3.dp else 1.dp, if (focused) Color(0xFFB7FFD1) else Color(0xFF587060), RoundedCornerShape(4.dp))
...
private fun ActionButton(label: String, onClick: () -> Unit) {
	...
	BasicText(
		...
		modifier = Modifier
			...
			.border(if (focused) 3.dp else 1.dp, if (focused) Color.White else Color(0xFF90D7B0), RoundedCornerShape(4.dp))
